...
#ifndef EXAMPLE_USER_SINLOOKUP_H_
#define EXAMPLE_USER_SINLOOKUP_H_



#endif /* EXAMPLE_USER_SINLOOKUP_H_ */
//no real reason for the number of steps to be base 2
const uint16_t sinTable64[64] = {
		...
		0x80,0x73,0x67,0x5a,0x4f,0x43,0x39,0x2f,0x25,0x1d,0x15,0xf,0xa,0x5,0x2,0x1,
		0x0,0x1,0x2,0x5,0xa,0xf,0x15,0x1d,0x25,0x2f,0x39,0x43,0x4f,0x5a,0x67,0x73

};

const uint16_t sinTable128[128] = {
 ...
 const uint16_t sinTable256[256]  = {
 ...
 const uint16_t sinTable512[512]  = {
